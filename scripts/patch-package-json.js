...
const packageJsonPath = path.join(__dirname, '../projects', 'ng-text-highlighter', 'package.json');
...
// Patch the fields
packageJson.name = '@supriyakundu99/ng-text-highlighter';
packageJson.publishConfig.registry = 'https://npm.pkg.github.com/';

// Write it back
try {
  fs.writeFileSync(packageJsonPath, JSON.stringify(packageJson, null, 2));
  console.log('✅ Patched projects/ng-text-highlighter/package.json successfully.');
} catch (err) {
